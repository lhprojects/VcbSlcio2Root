...
cp -fr /cefs/higgs/liangh/liangh/hig2zz/steer/knight2.xml  $RecoWorkDir/$OUTPUTDATA/${par}_${ojob}.xml
...
source /cefs/higgs/liangh/VTX/flavortag/storage/baseline/setup_cepcenv.sh
echo \
"#! /bin/bash
#unset MARLIN_DLL
...
export MARLIN_DLL=/afs/ihep.ac.cn/users/z/zhuyf/cefs/workspace/haoge/hig2zz/lib/libHiggs2zz.so.0.1.0:$MARLIN_DLL
