...
#ifndef RecoFASTJETPROCESSOR_H_
#define RecoFASTJETPROCESSOR_H_
...
class RecoFastJetProcessor : Processor
{
public:
	RecoFastJetProcessor();
	virtual ~RecoFastJetProcessor();

	virtual Processor* newProcessor()
	{
		return new RecoFastJetProcessor();
	}
...
private:
	...
	string  _lcParticleOutName3;
	string  _lcParticleOutName4;
