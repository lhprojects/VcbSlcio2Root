...
#ifndef GenFASTJETPROCESSOR_H_
#define GenFASTJETPROCESSOR_H_
...
class GenFastJetProcessor : Processor
{
public:
	GenFastJetProcessor();
	virtual ~GenFastJetProcessor();

	virtual Processor* newProcessor()
	{
		return new GenFastJetProcessor();
	}
